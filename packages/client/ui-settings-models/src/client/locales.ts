...
export const en = {
  ...
  cancelAccount: 'Cancel connection',
  submitAuthorization: 'Continue',
  openAuthorization: 'Open sign-in',
  selectAuthorizationOption: 'Select an option',
  accountConnected: 'Account connected.',
  accountConnectHint: 'Connect an account to use this provider.',
  accountEnableHint: 'An account is connected. Enable this provider to use it.',
  accountUnavailable: 'Account connection unavailable',
  accountInheritedKey: 'This provider has a deployment API key and cannot switch to account authentication.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  enableAccount: '启用',
  cancelAccount: '取消连接',
  submitAuthorization: '继续',
  openAuthorization: '打开登录页面',
  selectAuthorizationOption: '选择选项',
  accountConnected: '账户已连接。',
  accountConnectHint: '连接账户后即可使用此提供方。',
  accountEnableHint: '账户已连接。启用此提供方即可使用。',
  accountUnavailable: '账户连接不可用',
  accountInheritedKey: '此提供方使用部署提供的 API 密钥，无法切换到账户认证。',
